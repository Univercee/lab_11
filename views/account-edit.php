...
<div class="container-sm row d-flex flex-column align-items-center mb-5">
    <h2 class="col-md-6">Редактирование профиля</h2>
    <form action="account-edit-action" method="POST" class="col-md-12 d-flex flex-column gap-4">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <input class="form-check-input" type="radio" name="rh_factor" id="rhMinus" value="0" <?php echo !is_null($user["rh_factor"])&&$user["rh_factor"]==0?"checked":"" ?>></input>
                <label class="form-check-label" for="rhMinus">-</label>
                <input class="form-check-label" class="form-check-input" type="radio" name="rh_factor" id="rhPlus" value="1" <?php echo !is_null($user["rh_factor"])&&$user["rh_factor"]==1?"checked":"" ?>></input>
