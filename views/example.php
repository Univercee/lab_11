                ...
                <div class="row d-flex gap-4">
                    ...
                    <div class="col-12">
                        <div class="row d-flex align-items-center p-3" style="border-radius: 10px; border: solid lightgray 1px">
                            <div class="col-md-4 d-flex justify-content-center my-3" style="border-right: solid lightgray 1px">
                            ...
                            <div class="col-md-4 d-flex flex-column align-items-center my-3" style="border-right: solid lightgray 1px">
