<main class="w-100">
    <div class="container">
        <div class="row d-flex">
            <div class="col-md-8">
                <h4>4.1 ✅Апартаменты у метро! Самостоятельный заезд!🏰</h4>
            </div>
            <div class="col-md-4 d-flex gap-4 justify-content-end">
                <div class="d-flex align-items-center">
                    ...
                    <p class="my-0 mx-2">Поделиться</p>
                </div>
                <div class="d-flex align-items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style="display: block; fill: none; height: 16px; width: 16px; stroke: currentcolor; stroke-width: 2; overflow: visible;"><path d="M16 28c7-4.73 14-10 14-17a6.98 6.98 0 0 0-7-7c-1.8 0-3.58.68-4.95 2.05L16 8.1l-2.05-2.05a6.98 6.98 0 0 0-9.9 0A6.98 6.98 0 0 0 2 11c0 7 7 12.27 14 17z"></path></svg>
                    <p class="my-0 mx-2">Сохранить</p>
                </div>
            </div>
        </div>
        <div class="grid-container-img" style="width:100%;">
            <div class="img1">
                <img src="inc\images\7f99d680-dbea-4363-a2b2-2cf972108f84.webp" alt="img1" style="width: 100%; height:100%; object-fit:cover; border-radius: 10px 0 0 10px">
            </div>
            <div class="img2">
                <img src="inc\images\456b1b26-d051-4a17-bc5a-987e65c069eb.webp" alt="img2" style="width: 100%; object-fit:contain">
            </div>
            <div class="img3">
                <img src="inc\images\f7bdc83b-f956-411e-990e-be585a281c23.webp" alt="img3" style="width: 100%; object-fit:contain">
            </div>
            <div class="img4">
                <img src="inc\images\f8d01e27-f138-4e09-89c5-cf1c4ecf5c76.webp" alt="img4" style="width: 100%; object-fit:contain; border-radius: 0 10px 0 0">
            </div>
            <div class="img5">
                <img src="inc\images\f37f74e2-36fc-49f0-b668-256178b316bd.webp" alt="img5" style="width: 100%; object-fit:contain; border-radius: 0 0 10px 0">
            </div>
        </div>
        <div class="row d-flex justify-content-between">
                ...
                <div class="row d-flex gap-4">
                    ...
                    <div class="col-12">
                        <div class="row d-flex align-items-center p-3" style="border-radius: 10px; border: solid lightgray 1px">
                            ...
                            <div class="col-md-4 d-flex flex-column align-items-center my-3">
                                <h6 class="m-0">42</h6>
                                <p class="m-0" style="text-decoration: underline;">отзыва</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 section">
                        <div class="d-flex gap-3">
                            <div>
                                <img src="inc\images\87d2ead6-2b9c-4e09-b379-35176b3070eb.webp" alt="img" style="height: 50px; width: 50px; border-radius:50%; object-fit: cover">
                            </div>
                            <div>
                                <p class="m-0 bold">Хозяин: Алексей</p>
                                <p class="m-0">4 года принимает гостей</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 section">
                        <div class="d-flex flex-column gap-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <p class="m-0 bold">Самостоятельное прибытие</p>
                                    <p class="m-0">Вы заселитесь самостоятельно: ключи в мини-сейфе.</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <p class="m-0 bold">Можно с домашними животными</p>
                                    <p class="m-0">Возьмите в поездку домашних животных.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 section">
                        <p class="p-2" style="background-color: rgb(247, 247, 247); border-radius: 10px;">Часть информации переведена автоматически. <span class="bold text-decoration-underline">Показать оригинал</span></p>
                        <p>
                            Уютные апартаменты-студия в новом жилом комплексе премиум-класса. В 5-8 минутах пешком станция метро "Водный стадион". До Красной площади на метро 19 минут без пересадок!
                        </p>
                        <p>
                            Студия на севере Москвы, в одном из самых чистых и ухоженных районов. Сразу за домом Невский парк, в 400 метрах вход в Парк-усадьбу ... 
                        </p>
                        <div>
                            <p class="bold text-decoration-underline">Показать еще ></p>
                        </div>
                    </div>
                    <div class="col-12 section">
                        <h4>Где вы будете спать</h4>
                        <div class="p-4 w-50" style="border: solid lightgray 1px; border-radius: 10px;">
                            ...
                            <p class="bold mt-4 mb-1">Спальня</p>
                            <span>1 двуспальная кровать</span>
                        </div>
                    </div>
                    <div class="col-12 section">
                        <h4 class="mb-4">Какие удобства вас ждут</h4>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 24px; width: 24px; fill: currentcolor;"><path d="M26 19a1 1 0 1 1-2 0 1 1 0 0 1 2 0zM7 18a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm20.7-5 .41 1.12A4.97 4.97 0 0 1 30 18v9a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2v-2H8v2a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-9c0-1.57.75-2.96 1.89-3.88L4.3 13H2v-2h3v.15L6.82 6.3A2 2 0 0 1 8.69 5h14.62c.83 0 1.58.52 1.87 1.3L27 11.15V11h3v2h-2.3zM6 25H4v2h2v-2zm22 0h-2v2h2v-2zm0-2v-5a3 3 0 0 0-3-3H7a3 3 0 0 0-3 3v5h24zm-3-10h.56L23.3 7H8.69l-2.25 6H25zm-15 7h12v-2H10v2z"></path></svg>
                                    <p class="m-0">Бесплатная парковка на территории</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex gap-2 align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 24px; width: 24px; fill: currentcolor;"><path d="M13.7 13.93a4 4 0 0 1 5.28.6l.29.37 4.77 6.75a4 4 0 0 1 .6 3.34 4 4 0 0 1-4.5 2.91l-.4-.08-3.48-.93a1 1 0 0 0-.52 0l-3.47.93a4 4 0 0 1-2.94-.35l-.4-.25a4 4 0 0 1-1.2-5.2l.23-.37 4.77-6.75a4 4 0 0 1 .96-.97zm3.75 1.9a2 2 0 0 0-2.98.08l-.1.14-4.84 6.86a2 2 0 0 0 2.05 3.02l.17-.04 4-1.07a1 1 0 0 1 .5 0l3.97 1.06.15.04a2 2 0 0 0 2.13-2.97l-4.95-7.01zM27 12a4 4 0 1 1 0 8 4 4 0 0 1 0-8zM5 12a4 4 0 1 1 0 8 4 4 0 0 1 0-8zm22 2a2 2 0 1 0 0 4 2 2 0 0 0 0-4zM5 14a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm6-10a4 4 0 1 1 0 8 4 4 0 0 1 0-8zm10 0a4 4 0 1 1 0 8 4 4 0 0 1 0-8zM11 6a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm10 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"></path></svg>
                                    <p class="m-0">Можно с питомцами</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex gap-2 align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 24px; width: 24px; fill: currentcolor;"><path d="M9 29v-2h2v-2H6a5 5 0 0 1-5-4.78V8a5 5 0 0 1 4.78-5H26a5 5 0 0 1 5 4.78V20a5 5 0 0 1-4.78 5H21v2h2v2zm10-4h-6v2h6zm7-20H6a3 3 0 0 0-3 2.82V20a3 3 0 0 0 2.82 3H26a3 3 0 0 0 3-2.82V8a3 3 0 0 0-2.82-3z"></path></svg>
                                    <p class="m-0">Телевизор + Стандартное кабельное ТВ</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex gap-2 align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 24px; width: 24px; fill: currentcolor;"><path d="M26.29 2a3 3 0 0 1 2.96 2.58c.5 3.56.75 7.37.75 11.42s-.25 7.86-.75 11.42a3 3 0 0 1-2.79 2.57l-.17.01H5.7a3 3 0 0 1-2.96-2.58C2.25 23.86 2 20.05 2 16s.25-7.86.75-11.42a3 3 0 0 1 2.79-2.57L5.7 2zm0 2H5.72a1 1 0 0 0-1 .86A80.6 80.6 0 0 0 4 16c0 3.96.24 7.67.73 11.14a1 1 0 0 0 .87.85l.11.01h20.57a1 1 0 0 0 1-.86c.48-3.47.72-7.18.72-11.14 0-3.96-.24-7.67-.73-11.14A1 1 0 0 0 26.3 4zM16 7a9 9 0 1 1 0 18 9 9 0 0 1 0-18zm-5.84 7.5c-.34 0-.68.02-1.02.07a7 7 0 0 0 13.1 4.58 9.09 9.09 0 0 1-6.9-2.37l-.23-.23a6.97 6.97 0 0 0-4.95-2.05zM16 9a7 7 0 0 0-6.07 3.5h.23c2.26 0 4.44.84 6.12 2.4l.24.24a6.98 6.98 0 0 0 6.4 1.9A7 7 0 0 0 16 9zM7 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path></svg>
                                    <p class="m-0">Стиральная машина</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex gap-2 align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 24px; width: 24px; fill: currentcolor;"><path d="M23 1a2 2 0 0 1 2 1.85V19h4v2h-2v8h2v2H3v-2h2v-8H3v-2h4V3a2 2 0 0 1 1.85-2H9zM9 21H7v8h2zm4 0h-2v8h2zm4 0h-2v8h2zm4 0h-2v8h2zm4 0h-2v8h2zm-10-8H9v6h6zm8 0h-6v6h6zM15 3H9v8h6zm8 0h-6v8h6z"></path></svg>
                                    <p class="m-0">Дворик (патио) или балкон с частным доступом</p>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex gap-2 align-items-center">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 24px; width: 24px; fill: currentcolor;"><path d="M23 3a2 2 0 0 1 2 1.85v1.67l5-2v11.96l-5-2V16a2 2 0 0 1-1.85 2H16.9a5 5 0 0 1-3.98 3.92A5 5 0 0 1 8.22 26H4v4H2V20h2v4h4a3 3 0 0 0 2.87-2.13A5 5 0 0 1 7.1 18H4a2 2 0 0 1-2-1.85V5a2 2 0 0 1 1.85-2H4zM12 14a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm11-9H4v11h3.1a5 5 0 0 1 9.8 0H23zm5 2.48-3 1.2v3.64l3 1.2zM7 7a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"></path></svg>
                                    <p class="m-0">Камеры видеонаблюдения в жилье</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!--  -->
            <div class="col-md-4 col-sm-12 d-flex flex-column card-my">
                <div class="p-4">
                    <h5>2 676₽ <span class="fs-6">ночь</span></h5>
